...
if __name__ == "__main__":
    for dataset in datasets:
        ...
        for noisy_ratio in noisy_ratios:
            ...
            # test_model = hetcnn.HSI3DNet(data.num_classes).cuda()
            # test_model.test(data.train_dataset_noisy, data.test_dataset, epochs=1)
            ...
            common_utils.print_evaluation(pred, data.test_dataset[1], msg="> [hetcnn model]The accuracy of labels: ")
