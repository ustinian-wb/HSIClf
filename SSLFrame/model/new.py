...
class HetConv3D(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.spatial_conv = nn.Conv3d(in_channels, out_channels, kernel_size=(3, 3, 1), stride=(1, 1, 1),
                                      padding=(1, 1, 0))
        self.combine_conv = nn.Conv3d(in_channels, out_channels, kernel_size=(5, 5, 5), stride=(1, 1, 1),
                                      padding=(2, 2, 2))
    ...
    def forward(self, x):
        ...
        combine_out = F.relu(self.combine_bn(self.combine_conv(x)))
        out = spectral_out + spatial_out + combine_out
        return out
